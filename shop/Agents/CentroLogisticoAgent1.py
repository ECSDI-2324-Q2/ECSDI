...
def register_message():
    ...
    registerCentroLogistico(CentroLogisticoAgent, CentroLogisticoDirectoryAgent, agn.CentroLogisticoAgent, getMessageCount(),8028, '../data/ProductosCL1.owl')
